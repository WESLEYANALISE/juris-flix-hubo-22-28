import { X, Home, Scale, Headphones, Library, Bot, User, Settings, HelpCircle, 
         ...
         Watch, AlarmClock, Calendar as CalendarIcon, CalendarDays, Hammer, LogOut } from 'lucide-react';
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  className="flex-1 flex items-center gap-2 text-xs text-red-600 hover:text-red-700"
                >
              ...
              <div className="text-center pt-2">
                <div className="inline-flex items-center gap-2 text-xs text-muted-foreground">
                  ...
                  <span>{functions.length} ferramentas disponíveis</span>
                </div>
              </div>
            </div>
          </div>
